Feature: HROne Account Api's feature
  ...
  Given I want make a get call to "Bank" API using "GET" method
  
  Scenario: Validate get call to get the Bank Service Provider
  Given I want make a get call to "ServiceProvider" API using "GET" method
  
  Scenario: Validate get call to get the Bank is active 
  Given I want make a get call to "BankActive" API using "GET" method
  
  Scenario: Validate get call to get the Bank via Bank Code
  Given I want make a get call to "BankCode" API using "GET" method
	
	Scenario: Validate get call to get the Pay Mode
  Given I want make a get call to "PayMode" API using "GET" method
  
  Scenario: Validate get call to get all Bank Branches
  Given I want make a get call to "BankBranch" API using "GET" method
  
  Scenario: Validate get call to get Bank Branch by Code
  Given I want make a get call to "BankBranchByCode" API using "GET" method
  
  Scenario: Validate get call to get Bank Branch Challan
  Given I want make a get call to "BankChallan" API using "GET" method
  
  Scenario: Validate get call to get Bank Branch Alias List
  Given I want make a get call to "BankAlias" API using "GET" method
  
  Scenario: Validate get call to get Register Bank list by Bank Branch code
  Given I want make a get call to "BankList" API using "GET" method
  
  Scenario: Validate get call to get Candidate Status list 
  Given I want make a get call to "CandidateStatus" API using "GET" method
  
  Scenario: Validate get call to get Candidate Joining Source list
  Given I want make a get call to "JoiningSource" API using "GET" method
  
  Scenario: Validate get call to get Candidate Joining Source Category list
  Given I want make a get call to "Category" API using "GET" method
  ...
  Given I want make a get call to "CandidateFilter" API using "GET" method
  
  Scenario: Validate get call to get Candidate Social Profile list
  Given I want make a get call to "SocialProfile" API using "GET" method
  ...
  Given I want make a get call to "AssetCard" API using "GET" method
  
  Scenario: Validate get call to get Asset Card by FormID
  Given I want make a get call to "FormID" API using "GET" method
  
  Scenario: Validate get call to get Asset General Settings
  Given I want make a get call to "GeneralSettings" API using "GET" method
  
  Scenario: Validate get call to Auto Archive Service Settings
  Given I want make a get call to "AutoArchiveServiceSetting" API using "GET" method
